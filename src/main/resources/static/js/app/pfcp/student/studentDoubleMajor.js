...
document.addEventListener("DOMContentLoaded", () => {
	...
	const requestThing = document.querySelector("#requestThing");
	const initMultipleMajor = requestThing.dataset.initMultipleMajor;
	...
	axios.get(`${CPATH}/staff/professorManagement/departmentList.do`).then(resp => {
			...
			if (departmentList) {
	           ...
	           requestThing.innerHTML += options;
	
	           requestThing.value = initMultipleMajor ?? "";
	       }
	})
})