...
<!-- 				src="/dist/assets/img/kaiadmin/logo_pathFinder_white.png" -->
...
<!-- 								href="#subnav1"> <i class="fas fa-bars"></i> -->
<!-- 									<p>제품</p> <span class="caret"></span> -->
<!-- 							</a> -->
<!-- 								<div class="collapse" id="subnav1"> -->
<!-- 									<ul class="nav nav-collapse subnav"> -->
<!-- 										<li><a href="/prod/prodList.do"> <span -->
<!-- 												class="sub-item">제품리스트</span> -->
<!-- 										</a></li> -->
<!-- 										<li><a href="/prod/prodInsert.do"> <span class="sub-item">제품 등록</span> -->
<!-- 										</a></li> -->
<!-- 									</ul> -->
<!-- 								</div></li> -->

<!-- 							<li class="nav-item"><a data-bs-toggle="collapse" -->
<!-- 								href="#subnav2"> <i class="fas fa-bars"></i> -->
<!-- 									<p>Level 1</p> <span class="caret"></span> -->
<!-- 							</a> -->
...
<!-- 							<li class="nav-item"><a href="#"> <i class="fas fa-bars"></i> -->
<!-- 									<p>Level 1</p> -->
<!-- 							</a></li> -->
<!-- 						</ul> -->
<!-- 					</div> -->
