...
<div class="section">
	<div class="card">
		<form> 
            ...
            <button type="button" class="cancelButton" onclick="location.href='/professor/attendance/attendclassList.do'" style="float:right; margin-right:20px;">목록</button>
		</form>
	</div>
					...
					<tbody>
						<c:choose>
							<c:when test="${not empty studentList }">
								...
								<c:url value="/professor/attendance/attendanceStdList.do" var="detailURL">
									<c:param name="userNo" value="${student.userNo}" />
								</c:url>
									<tr class="tableRowHover" onclick="moveToAttendance(this)" data-user-no="${student.userNo}" data-enr-no="${student.enrollNo}">
