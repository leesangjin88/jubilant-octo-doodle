...
<h2 class="sectionTitle">강의 수정</h2>
<div class="section">
	<div class="card">
		<form method="post" action="/professor/attendclass/attendclassUpdateProcess.do" enctype="multipart/form-data">
			...
			<div class="form-row" style="display: flex; gap: 20px;">
				<div class="form-group" style="flex: 1;">
				    ...
				    <select id="subjectCode" name="subjectCode" class="selectBox" data-init-val="${lectureReq.subjectCode}" readonly>
			...
			<div class="form-row" style="display: flex; gap: 20px;">
				<div class="form-group" style="flex: 1;">
					...
					<select id="lecCategory" name="lecCategory" class="selectBox" data-init-val="${lectureReq.lecCategory}" readonly>
			...
			<div class="form-row" style="display: flex; gap: 20px;">
				<div class="form-group" style="flex: 1;">
					...
					<select id="preClassrm" name="preClassrm" class="selectBox" data-init-val="${lectureReq.preClassrm}" readonly>
            ...
            <button type="button" class="cancelButton" onclick="location.href='/professor/attendclass/attendclassDetail.do?no=${lectureReq.reqNo}'" style="float:right; margin-right:20px;">이전</button>
		</form>
	</div>
</div>