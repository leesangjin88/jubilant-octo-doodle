...
<body>
	...
	<div class="card" style="margin-bottom: 1rem;">
		<button id="toggleFilter" class="filterButton active">필터
			열기</button>
		<div id="filterBox"
			style="display: none; overflow: hidden; transition: all 0.3s ease;">
			<div class="form-group">
				<label class="inputLabel" for="filterType">일정 유형</label> <select
					id="filterType" class="selectBox">
			...
			<div class="form-group">
				<label class="inputLabel" for="filterStart">시작일</label> <input
					type="date" id="filterStart" class="inputField" />
			</div>
			<div class="form-group">
				<label class="inputLabel" for="filterEnd">종료일</label> <input
					type="date" id="filterEnd" class="inputField" />
			</div>
			...
			<form:form id="scheduleForm" method="post"
				...
				<div class="form-row">
					<div class="form-group">
						...
						<form:input path="scheduleTitle" id="scheduleTitle"
							cssClass="inputField" required="required" />
					...
					<div class="form-group">
						...
						<form:select path="type.scheduleTypeNo" id="scheduleType"
							cssClass="selectBox" required="required">
				...
				<div class="form-group">
					...
					<form:textarea path="scheduleDesp" id="scheduleDesp"
						cssClass="textareaField" placeholder="상세 설명을 입력하세요" />
					<form:errors path="scheduleDesp" cssClass="error" />
				</div>
				<div class="button-group">
					<button class="editButton" type="button" id="resetBtn"
						style="display: none;">돌아가기</button>
					<button type="submit" id="submitBtn" class="submitButton">등록</button>
					<button type="button" id="resetBtn" class="cancelButton"
						style="display: none;">초기화</button>
				</div>
			</form:form>
		</div>
	</div>
