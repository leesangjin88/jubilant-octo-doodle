...
<form method="post" action="/student/counsel/employmentCounsel/employmentCounselInsertProcess.do">
	...
	<input type="hidden" id="typeCode" name="typeCode" class="form-control" value="CN_EMP" readonly>
